#!/usr/bin/env python3
"""
SAPM Monte Carlo Simulation — Plastics / Thermodynamic Degradation Floor
==========================================

Reproduces all quantitative results in:

  Postnieks, E. (2026). SAPM Working Paper: Plastics (Thermodynamic Degradation Floor).
  Available: SSRN.
...
CONFIG = {
    "paper_id": "plastics",
    "domain_name": "Plastics",
    "theorem": "Thermodynamic Degradation Floor",
    "classification": "Class 1 \u2014 Impossibility",
    "seed": 42,
    "n_draws": 100000,
    "correlation_rho": 0.3,
    "private_payoff_B": 650.0,
    "channels": {
        "C1_health_microplastics": {
            ...
            "high": 3000.0,
            "weight": 0.26,
            "description": "Endocrine disruptors, microplastic ingestion, PFAS-coated packaging, cancer risk. $1.0-3.0T/yr. Sources: Lancet, Minderoo Foundation, WHO."
        },
        "C2_climate_ghg": {
            "dist": "normal",
            "low": 150.0,
            ...
            "high": 300.0,
            "weight": 0.039,
            "description": "GHG emissions from petrochemical production (1.8 Gt CO\u2082e/yr \u00d7 SCC). Sources: CIEL, IEA, EPA SCC."
        },
        "C3_ocean_ecosystem": {
            "dist": "lognormal",
            "low": 500.0,
            ...
            "high": 3100.0,
            "weight": 0.26,
            "description": "Marine debris, microplastic contamination, coral reef damage, fisheries impact. Sources: Beaumont et al. 2019, UNEP."
        },
        "C4_waste_management": {
            "dist": "lognormal",
            "low": 80.0,
            ...
            "high": 200.0,
            "weight": 0.021,
            "description": "Municipal waste management, cleanup, landfill, incineration costs. Sources: World Bank, ISWA."
        },
        "C5_environmental_justice": {
            ...
            "high": 650.0,
            "weight": 0.061,
            "description": "Global South open burning, waste colonialism, fenceline community health burden. Sources: IPEN, Basel Action Network."
        },
        "C6_governance_capture": {
            ...
            "high": 800.0,
            "weight": 0.088,
            "description": "Petrochemical treaty sabotage, recycling theater, manufactured consumer blame. Sources: CIEL, UNEA INC negotiations."
        }
    },
